...
INSERT INTO `simplonclick`.`membre` (`pseudo`, `password`,`nom`, `prenom`, `admin`, `email`, `pseudo_slack`, `image`, `fonction`, `niveau_general`, `disponibilite_habituelle`, `disponibilite_actuelle`) VALUES ('Gafa', 'TEST', 'Gallan', 'Fabien', 'oui', 'test@test.com', 'Gafan', 'imagetest', 'apprenant', 'novice', 'Lundi 18h', 'oui');
INSERT INTO `simplonclick`.`membre` (`pseudo`, `password`,`nom`, `prenom`, `admin`, `email`, `pseudo_slack`, `image`, `fonction`, `niveau_general`, `disponibilite_habituelle`, `disponibilite_actuelle`) VALUES ('Tost', 'TEST', 'Toby', 'Stephan', 'non', '', 'test@test.com', 'Toste', 'imagetest', 'apprenant', 'intermediaire', 'Mardi 18h', 'oui');
INSERT INTO `simplonclick`.`membre` (`pseudo`, `password`,`nom`, `prenom`, `admin`, `email`, `pseudo_slack`, `image`, `fonction`, `niveau_general`, `disponibilite_habituelle`, `disponibilite_actuelle`) VALUES ('Chama', 'TEST', 'Charru', 'Marc', 'non', 'ADMIN', 'test@test.com', 'Chaman', 'imagetest', 'formateur', 'expert', 'Mercredi 18h', 'non');
INSERT INTO `simplonclick`.`membre` (`pseudo`, `password`,`nom`, `prenom`, `admin`, `email`, `pseudo_slack`, `image`, `fonction`, `niveau_general`, `disponibilite_habituelle`, `disponibilite_actuelle`) VALUES ('Malo', 'TEST', 'Louve', 'Marie', 'oui', 'ADMIN', 'test@test.com', 'Malou', 'imagetest', 'apprenant', 'confirme', 'Vendredi 18h', 'oui');
