...
public class NiveauSavoirDAO {
	...
	@Autowired
	public NiveauSavoirDAO(JdbcTemplate jdbcTemplate) {
		this.dataSource = jdbcTemplate.getDataSource();
	}
	
	/**
	 * Rechercher les inscriptions liées à un niveau de savoir
	 * 
	 * @param id
	 * @return
	 * @throws Exception
	...
	public List<Inscription> recupererInscriptionsDeSavoir(Long id) throws Exception {
		...
		try {
			...
			sql = "SELECT inscription.*\r\n" + 
					...
					"FROM inscription\r\n" + 
					"WHERE niveau_savoir_id_niveau_savoir = ?);";
